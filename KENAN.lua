...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/KENANNTEAM/Files_KENAN/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevKENANW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevKENANW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevKENANW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevKENANW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevKENANW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevKENANW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevKENANW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "SourceKENANe")
...
local KENAN_Msg = ''  
if msgs < 100 then 
KENAN_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
KENAN_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
KENAN_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
KENAN_Msg = 'متفاعل' 
elseif msgs < 1200 then 
KENAN_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
KENAN_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
KENAN_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
KENAN_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
KENAN_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
KENAN_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
KENAN_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
KENAN_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
KENAN_Msg = 'رب التفاعل'  
end 
return KENAN_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceKENAN(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
if DevKENANW(msg) then
local bl = ' *⌔︙اهلا عزيزي آلمـطـور*\n*⌔︙آنت آلمـطـور آلآسـآسـي للبوت*\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n*⌔︙تسـتطـيع‌‏ آلتحگم باوامر البوت*\n*⌔︙من خلاال الكيبورت خاص بك*\n*⌔︙قناة سورس البوت *[اضغط هنا](t.me/SourceKENANe)'
local keyboard = {
...
local list = database:smembers(bot_id.."KENAN1:List:Filter"..sl)
...
if not DevKENANW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevKENANW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,KENAN_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⌔' and DevKENANW(msg) then  
...
if text == 'تعطيل التواصل ⌔' and DevKENANW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌔' and DevKENANW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌔' and DevKENANW(msg) then  
...
if text == 'ضع كليشه ستارت ⌔' and DevKENANW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌔︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌔' and DevKENANW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌔︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌔' and DevKENANW(msg) then 
...
if text == 'تحديث السورس ⌔' and DevKENANW(msg) then 
os.execute('rm -rf KENAN.lua')
os.execute('wget https://raw.githubusercontent.com/KENANNTEAM/KENAN/main/KENAN.lua')
send(msg.chat_id_, msg.id_,' *⌔︙تم تحديث السورس* \n*⌔︙لديك اخر اصدار لسورس لارفين*\n*⌔︙الاصدار » { 2.8v}*')
dofile('KENAN.lua')  
end
if text == 'الاصدار ⌔' and DevKENANW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌔︙اصدار سورس لارفين* \n*⌔︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌔' and DevKENANW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌔︙[تحديثات البوت](t.me/i600ik) \n⌔︙[قناه السورس](t.me/SourceKENANe)')
end
if text == "ضع اسم للبوت ⌔" and DevKENANW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌔' and DevKENANW(msg) then 
...
if text == 'المشتركين ⌔' and DevKENANW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌔︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌔' and DevKENANW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌔︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌔") and DevKENANW(msg) then
...
if text == ("قائمه العام ⌔") and DevKENANW(msg) then
...
if text == ("قائمه الكتم العام ⌔") and DevKENANW(msg) then
...
if text=="اذاعه خاص ⌔" and msg.reply_to_message_id_ == 0 and DevKENANW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل الان اذاعتك؟* \n*⌔︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌔" and msg.reply_to_message_id_ == 0 and DevKENANW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل الان اذاعتك؟* \n*⌔︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌔" and msg.reply_to_message_id_ == 0 and DevKENANW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل الان اذاعتك؟* \n*⌔︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌔" and msg.reply_to_message_id_ == 0  and DevKENANW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌔" and msg.reply_to_message_id_ == 0  and DevKENANW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌔︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌔' and DevKENANW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌔" and DevKENANW(msg) then
...
if text == "تنظيف الكروبات ⌔" and DevKENANW(msg) then 
...
send(msg.chat_id_, msg.id_,'*⌔︙عدد الكروبات الان » { '..#group..' }'..KENANk..''..KENAN..'*\n*⌔︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevKENANW(msg) then
...
usertext = '*\n ⌔︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'SourceKENANe')..')'
status  = '\n *⌔︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevKENANW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌔︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceKENANe')..')'
status  = '\n*⌔︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevKENANW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevKENANW(msg) then
...
local KENAN1_Msg = database:get(bot_id.."KENAN1:Add:Filter:Rp2"..text..msg.chat_id_)   
if KENAN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌔︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceKENANe')..') \n ⌔︙'..KENAN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if KENAN_Msg and not Special(msg) then  
local KENAN_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if KENAN_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌔︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌔︙["..KENAN_Msg.."] \n")
else
send(msg.chat_id_,0," *⌔︙العضو :* {["..data.first_name_.."](T.ME/SourceKENANe)}\n⌔︙["..KENAN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⌔︙عذرا ↫* {["..data.first_name_.."](T.ME/SourceKENANe)}\n*⌔︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevKENANW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevKENANW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevKENANW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌔︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevKENANW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌔︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌔" and DevKENANW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌔︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌔$") and DevKENANW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌔︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌔" and DevKENANW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⌔" and DevKENANW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌔︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌔" and DevKENANW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."KENAN:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."KENAN:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_KENAN = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_KENAN then 
names_KENAN = database:smembers(bot_id.."KENAN:blocname"..msg.chat_id_) or ""
if names_KENAN and names_KENAN[1] then 
for i=1,#names_KENAN do 
if name_KENAN:match("(.*)("..names_KENAN[i]..")(.*)") then 
...
database:set(bot_id.."KENAN:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."KENAN:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."KENAN:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."KENAN:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."KENAN:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_KENANa_new(KENAN1,KENAN2)
if KENAN2 and KENAN2.first_name_ then 
if KENAN2.first_name_:match("(.*)"..database:get(bot_id.."KENAN:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."KENAN:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local KENAN_nnn = database:get(bot_id.."KENAN:nump"..msg.chat_id_) or 5
local KENAN_nnn2 = database:get(bot_id.."KENAN:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(KENAN_nnn2) == tonumber(KENAN_nnn) or tonumber(KENAN_nnn2) > tonumber(KENAN_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."KENAN:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌔︙عزيزي >>["..KENAN2.username_.."](https://t.me/"..(KENAN2.username_ or "SourceKENANe")..")\n⌔︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."KENAN:teh"..msg.chat_id_).."} بجانب اسمك\n⌔︙عدد المحاولات المتبقيه {"..(tonumber(KENAN_nnn) - tonumber(KENAN_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_KENANa_new)
end
end
...
local KENANChengName = database:get(bot_id.."KENAN:Cheng:Name"..data.id_)
if not data.first_name_ then 
if KENANChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..KENANChengName..']')
database:del(bot_id.."KENAN:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if KENANChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."KENAN:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local KENANChengUserName = database:get(bot_id.."KENAN:Cheng:UserName"..data.id_)
if not data.username_ then 
if KENANChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..KENANChengUserName..']')
database:del(bot_id.."KENAN:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if KENANChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."KENAN:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local KENANChengPhoto = database:get(bot_id.."KENAN:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if KENANChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."KENAN:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if KENANChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."KENAN:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
⌔︙KENAN TEAM
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⌔︙[Source Files](http://t.me/SourceKENANe)

⌔︙[Source Channel](https://t.me/i600ik/15)

⌔︙[TWS KENAN](http://t.me/vBvbot) 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
...
if text == 'رفع نسخه الاحتياطيه' and DevKENANW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*⌔︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceKENANe')..') \n*⌔︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌔︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SourceKENANe')..') \n*⌔︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevKENANW(msg) then
dofile('KENAN.lua')  
send(msg.chat_id_, msg.id_, ' *⌔︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevKENANW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevKENANW(msg) then  
function start_function(extra, result, success)
if KENANSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevKENANW(msg) then  
...
if KENANSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌔︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevKENANW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if KENANSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌔︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevKENANW(msg) then  
function start_function(extra, result, success)
if KENANSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌔︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevKENANW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevKENANW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if KENANSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌔︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevKENANW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevKENANW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevKENANW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevKENANW(msg) then
...
if text == 'الملفات' and DevKENANW(msg) then
...
if DevKENANW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/KENANNTEAM/Files_KENAN/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⌔︙اهلا بك في متجر ملفات لارفين*\n*⌔︙ملفات السورس ↓*\n*ٴ┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉ٴ*\n\n"
local TextE = "\n*ٴ┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉ٴ*\n *⌔︙علامة تعني { ✓ } ملف مفعل*\n *⌔︙علامة تعني { ✘ } ملف معطل*\n *⌔︙قناة سورس لارفين ↓*\n".." *⌔︙*[اضغط هنا لدخول](t.me/SourceKENANe) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevKENANW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/KENANNTEAM/Files_KENAN/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevKENANW(msg) then
...
if text == "مسح الملفات" and DevKENANW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌔︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevKENANW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevKENANW(msg) then  
function start_function(extra, result, success)
...
local UserName = (b.username_ or "SourceKENANe")
...
function Function_KENAN(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_KENAN, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_KENAN, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌔︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceKENANe')..')'
status  = '\n*⌔︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌔︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceKENANe')..')'
status  = '\n*⌔︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌔︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌔︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceKENANe')..')'
...
database:set(bot_id.."KENAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."KENAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌔︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."KENAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."KENAN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."KENAN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."KENAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌔︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."KENAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."KENAN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."KENAN1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."KENAN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌔︙ارسل الكلمه الان*")  
database:set(bot_id.."KENAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."KENAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."KENAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KENAN1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."KENAN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."KENAN1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."KENAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KENAN1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."KENAN1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevKENANW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌔︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevKENANW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌔︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'SourceKENANe')..')'..'\n*⌔︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevKENANW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevKENANW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..KENAN_Msg[math.random(#KENAN_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevKENANW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,KENAN)
local t = "\n*ツ قائمة الاعضاء* \n*ٴ┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉ٴ*\n"
x = 0
local list = KENAN.members_
for k, v in pairs(list) do
x = x + 1
...
if KENANSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevKENANW(msg) then 
...
if text == ("ردود المطور") and DevKENANW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌔︙قائمة ردود المطور \n*ٴ┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉ٴ*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevKENANW(msg) then    
send(msg.chat_id_, msg.id_,' *⌔︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevKENANW(msg) then    
...
if text == 'تفعيل المغادره' and DevKENANW(msg) then   
...
if text == 'تعطيل المغادره' and DevKENANW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceKENANe')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
KENANdx(msg.chat_id_, msg.id_, ' *⌔︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌔︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌔︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌔︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevKENANW(msg) then
...
*⌔م10 ◂ اوامر الاعضاء*
ٴ*ٴ┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉ٴ*ٴ
[彡 𝑳𝐀𝐑𝐕𝐈𝐍 𝐓𝐄𝐀𝐌 ➢ ](t.me/SourceKENANe) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
KENAN = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(KENAN)
...
--------------------------------------------------------------------------------------------------------------
SourceKENAN(data.message_,data)
...
------------------------------------------------------------------------
local KENANAbot = database:get(bot_id.."KENAN1:Add:Filter:Rp2"..text..result.chat_id_)   
if KENANAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌔︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌔︙["..KENANAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local KENAN1_Msg = database:get(bot_id.."KENAN1:Add:Filter:Rp2"..text..result.chat_id_)   
if KENAN1_Msg then
send(msg.chat_id_, msg.id_," ⌔︙"..KENAN1_Msg)
